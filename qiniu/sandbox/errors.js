...
exports.InvalidArgumentError = defineError('InvalidArgumentError');
exports.NotFoundError = defineError('NotFoundError');
exports.FileNotFoundError = defineError('FileNotFoundError');
exports.SandboxNotFoundError = defineError('SandboxNotFoundError');
