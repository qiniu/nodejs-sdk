...
Service.prototype.uploadMultipartData = function(url, filepath, actionString, callbackQueryString, uploadToken, onret) {
  var form = formstream();
...
Service.prototype.uploadWithToken = function(uploadToken, localFile, bucket, key, mimeType, customMeta, callbackParams, enableCrc32Check, onret) {
  ...
  return this.uploadMultipartData(url, localFile, actionString, callbackQueryString, uploadToken, onret);
}
