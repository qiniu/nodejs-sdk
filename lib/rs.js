...
Service.prototype.setStyle = function(name, style, onret){
	var url = cofig.PUB_HOST + "/style/" + this.bucket + "/name/" + encodeURIComponent(name) + "/style/" + encodeURIComponent(style);
	this.conn.callWith(url, null, onret);
}

Service.prototype.unsetStyle = function(name, onret){
	var url = cofig.PUB_HOST + "/style/" + this.bucket + "/name/" + encodeURIComponent(name);
	this.conn.callWith(url, null, onret);
}
