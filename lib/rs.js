...
Service.prototype.setSeparator = function(sep, onret){
	var url = config.PUB_HOST + "/separator/" + this.bucket + "/sep/" + encodeURIComponent(sep);
	this.conn.callWith(url, null, onret);
}

Service.prototype.setStyle = function(name, style, onret){
	var url = config.PUB_HOST + "/style/" + this.bucket + "/name/" + encodeURIComponent(name) + "/style/" + encodeURIComponent(style);
	this.conn.callWith(url, null, onret);
}

Service.prototype.unsetStyle = function(name, onret){
	var url = config.PUB_HOST + "/style/" + this.bucket + "/name/" + encodeURIComponent(name);
	this.conn.callWith(url, null, onret);
}
