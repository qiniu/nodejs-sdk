...
// ------------------------------------------------------------------------------------------
// func checksum
function checksum(secretKey, opt, body) {
...
// ------------------------------------------------------------------------------------------
// type QiniuClient
function QiniuClient(accessKey, secretKey){
    this.ACCESS_KEY = accessKey;
    this.SECRET_KEY = secretKey;
}

QiniuClient.prototype.auth = function(opt, params) {
	opt.headers['Authorization'] = 'QBox ' + this.ACCESS_KEY + ':' + checksum(this.SECRET_KEY, opt, params)
};

QiniuClient.prototype.execute = function(url, params, onresp, onerror) {
...
QiniuClient.prototype.callWith = function(url, params, onret) {
